...
PG_READY_CMD="pg_isready -U $PG_USER -d $PG_DBNAME -h localhost -p 5432"

echo "Master Script: Waiting for PostgreSQL to start..."
until $PG_READY_CMD; do
  >&2 echo "Postgres is unavailable - sleeping"
  sleep 1
done
echo "Master Script: PostgreSQL started."
