...
from apps.exchange.models import Asset
...
class Instrument:
    ...
    def from_json(cls, data: List[Any]) -> List['Instrument']:
        ...
        for item in data:
            ...
            # 我们这里的base和quote相反
            instrument.base_asset = Asset.objects.get(symbol=item['quote_currency'])
    ...
    def from_okex_json(cls, data: List[Dict[str, Any]]) -> List['Instrument']:
        ...
        for item in data:
            ...
            instrument.base_asset = Asset.objects.get(symbol='USD')
