...
from apps.exchange.models import TradingPair, Asset, Exchange


class MgObPersistence(BaseModel):
    symbol = models.ForeignKey(
        TradingPair, related_name='price_symbol',
    ...
    def as_dict(self):
        return {
            'symbol': self.symbol.symbol_display if self.symbol else None,
