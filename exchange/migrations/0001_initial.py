    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_asset', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='base_symbols', to='exchange.Asset', verbose_name='base资产')),
                ('exchanges', models.ManyToManyField(related_name='symbols', through='exchange.ExchangeSymbolShip', to='exchange.Exchange', verbose_name='关联交易所')),
                ('quote_asset', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='quote_symbols', to='exchange.Asset', verbose_name='报价资产')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exchange', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='accounts', to='exchange.Exchange')),
            ],
        ),
